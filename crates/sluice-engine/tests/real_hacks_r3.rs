//! Real historical DeFi hack regression test — round 4 (`_r3`).
//!
//! A FOURTH, independent real-hack harness alongside `real_hacks.rs`,
//! `real_hacks_r1.rs`, and `real_hacks_r2.rs`. It covers a distinct set of
//! incidents and detector attributions. Each fixture under
...
const HACKS: &[(&str, &str, &str)] = &[
    ("warp.sol", "oracle-manipulation", "Warp Finance ($7.8M LP-token oracle, Dec 2020)"),
    ("grim.sol", "erc777-reentrancy", "Grim Finance ($30M ERC777 vault reentrancy, Dec 2021)"),
    ("revest.sol", "reentrancy", "Revest Finance ($2M ERC1155 reentrancy, Mar 2022)"),
    ("xsurge.sol", "reentrancy", "xSurge / SurgeToken ($25M sell-reentrancy, Aug 2021)"),
    ("furucombo.sol", "upgradeable", "Furucombo ($14M evil-proxy delegatecall, Feb 2021)"),
    ("cover.sol", "access-control", "Cover Protocol ($4M infinite-mint, Dec 2020)"),
    ("lifi.sol", "arbitrary-transfer", "LI.FI ($600K arbitrary external call, Mar 2022)"),
    ("spartan.sol", "oracle-manipulation", "Spartan Protocol ($30M LP-share manipulation, May 2021)"),
];
...
#[test]
fn flags_real_historical_hacks_r3() {
    ...
    eprintln!("\n=== Real historical DeFi hacks — round 4 (named detector MUST fire) ===");
